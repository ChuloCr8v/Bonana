...
import { Form, Input, Button, ConfigProvider, theme as antdTheme, App as AntdApp } from 'antd';
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
        <Form.Item
          ...
          rules={[{ required: true, message: 'Please enter your name or organization' }]}
        >
          <Input
            size="large"
      ...
      <div className="pt-2 flex items-center">
        <Button
          ...
          size="large"
          className="h-11 px-8 font-mono text-xs font-semibold bg-black text-white hover:bg-zinc-800 border-black inline-flex items-center justify-center gap-2 rounded-none cursor-pointer"
        >
      ...
      <div className="p-5 sm:p-6 bg-[var(--surface-alt)]/40 border-b border-[var(--border)]">
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-black text-white hover:bg-zinc-800 border border-black px-4 py-2 text-xs font-mono font-semibold inline-flex items-center gap-2 shadow-xs transition-colors"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-white text-black hover:bg-zinc-100 border border-zinc-300 px-4 py-2 text-xs font-mono font-semibold inline-flex items-center gap-2 shadow-xs transition-colors"
          >
          ...
          <button
            ...
            className="bg-black text-white hover:bg-zinc-800 border border-black px-4 py-2 text-xs font-mono font-semibold inline-flex items-center gap-2 shadow-xs transition-colors cursor-pointer"
          >
          ...
          <a
            ...
            className="bg-white text-black hover:bg-zinc-100 border border-zinc-300 px-4 py-2 text-xs font-mono font-semibold inline-flex items-center gap-2 shadow-xs transition-colors cursor-pointer"
            ...
            {submittedData ? (
              <div className="border border-emerald-500/40 bg-emerald-500/10 p-6 sm:p-8 text-center space-y-4">
                ...
                <p className="text-xs sm:text-sm text-[var(--text-muted)] max-w-md mx-auto leading-relaxed">
                  Thanks for reaching out, <span className="font-semibold text-[var(--text-main)]">{submittedData.name}</span>. I have received your message and will get back to you shortly at <span className="font-mono text-xs">{submittedData.email}</span>.
                </p>
                <div className="pt-2">
                  <button
                    onClick={() => setSubmittedData(null)}
                    className="px-5 py-2 text-xs font-mono font-medium border border-[var(--border)] bg-[var(--surface)] text-[var(--text-main)] hover:border-[var(--text-main)] transition-colors cursor-pointer"
                  >
              ...
              <div className="space-y-6">
                <div className="border-b border-[var(--border)] pb-3">
                  ...
                  <p className="text-xs text-[var(--text-muted)] mt-1">
                    Fill out the form below and I&rsquo;ll get back to you as soon as I can.
                  </p>
                </div>
