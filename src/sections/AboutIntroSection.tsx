        ...
        >
          ...
          >
            {skillsList.map((item, idx) => (
              <div
                key={`${item}-${idx}`}
                className={`w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-[12.5%] shrink-0 snap-start snap-always py-3 sm:py-3.5 px-2.5 text-center flex items-center justify-center border-r border-[var(--border)] text-xs sm:text-sm font-semibold tracking-tight bg-transparent ${
                  idx % 2 === 0
