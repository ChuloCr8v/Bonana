...
export const ALL_PROJECTS: Project[] = [
  {
    ...
    tagline:
      'AI-assisted CV and job application workspace for tailoring resumes to specific roles.',
    ...
    imageAlt:
      'QikCV AI resume builder interface and PDF generation engine',

    galleryImages: [
      {
        url: dashboardImg,
        title: 'QikCV Dashboard',
        caption:
          'Central dashboard for managing tailored CVs, job applications, and resume optimization activity.'
      },
      {
        url: qikcvImgOne,
        title: 'Customized CV',
        caption:
          'Tailored CV view showing the generated resume content adapted to a specific job description.'
      },
      {
        url: qikcvImgTwo,
        title: 'ATS Score Analysis',
        caption:
          'ATS analysis showing how closely the customized CV matches the target job requirements.'
      },
      {
        url: qikcvImgThree,
        title: 'CV Difference View',
        caption:
          'Side-by-side comparison highlighting changes between the original CV and the customized version.'
      }
    ],
    ...
    role:
      'Designed and built the product across frontend and backend, including the document workflow, generation pipeline, CV editing experience, exports, application tracking, and supporting APIs.',
    ...
    architecture: {
      frontend:
        'React, Vite, TypeScript, Tailwind CSS, Ant Design, Redux Toolkit.',

      backend:
        'NestJS REST API, Node.js runtime, BullMQ Redis worker queue for document processing.',

      database:
        'PostgreSQL managed with Prisma ORM for user documents, revisions, and billing ledgers.',

      infrastructure:
        'Docker container deployments, S3 document storage, CloudFront CDN, Stripe Webhooks.'
    },
...

  {
    ...
    tagline:
      'Telegram automation platform for managing broadcast campaigns and messaging workflows.',
    ...
    imageAlt:
      'Qikbot community broadcast dashboard and subscriber tier management',

    galleryImages: [
      {
        url: qikbotimg3,
        title: 'Curated Posts Dashboard',
        caption:
          'Dashboard showing curated posts created from articles collected through the platform.'
      },
      {
        url: qikbotimg1,
        title: 'Original Article',
        caption:
          'View of the original web article collected as the source for content processing.'
      },
      {
        url: qikbotimg2,
        title: 'Generated Post',
        caption:
          'Processed Telegram-ready post generated from the selected source article.'
      },
      {
        url: qikbotimg4,
        title: 'News Feeds',
        caption:
          'News feed management view showing sources and articles available for content curation.'
      }
    ],
    ...
    role:
      'Designed and implemented the application architecture, backend workflows, queue processing, integrations, and supporting product interfaces.',
    ...
    architecture: {
      frontend:
        'React, TypeScript, Redux Toolkit, Tailwind CSS, Ant Design data grids.',

      backend:
        'NestJS modular architecture, Node.js, Telegram Bot API long-polling & webhooks.',

      database:
        'PostgreSQL with Prisma ORM, Redis for message queues and rate-limit counters.',

      infrastructure:
        'Oracle Cloud Infrastructure (OCI) Compute, Docker, Caddy reverse proxy, Stripe Webhooks.'
    },
...

  {
    ...
    imageAlt:
      'OSSYard open-source package discovery directory',
    ...
    role:
      'Creator & frontend engineer: GitHub API ingestion, repository scoring, and responsive directory interface.',
    ...
    architecture: {
      frontend:
        'React, TypeScript, Tailwind CSS, Fuse.js client search.',

      backend:
        'Serverless functions consuming GitHub GraphQL & REST APIs.',

      database:
        'Static JSON dataset regenerated via automated GitHub Actions.',

      infrastructure:
        'Vercel edge deployment with global CDN caching.'
    },
...

  {
    ...
    tagline:
      'Digital inspection and certification platform supporting inspection requests, payments, document submissions, and certification workflows.',
    ...
    role:
      'Worked across both frontend and backend development, implementing features, API integrations, data workflows, and ongoing product improvements.',
    ...
    architecture: {
      frontend:
        'React, TypeScript, Ant Design UI components.',

      backend:
        'NestJS REST API, Node.js backend services.',
...

  {
    ...
    tagline:
      'Digital employee management platform replacing paper-based HR processes with structured workflows and centralized employee data.',
    ...
    role:
      'Worked across frontend and backend development, implementing features, APIs, data workflows, and product improvements.',
    ...
    architecture: {
      ...
      backend:
        'NestJS REST API, Node.js runtime.',
...

  {
    ...
    tagline:
      'Service management platform supporting dashboards, licenses, field operations, ticketing, surveys, and operational analytics.',
    ...
    role:
      'Contributed to product development across frontend and backend features, dashboards, workflows, and integrations.',
    ...
    architecture: {
      frontend:
        'React, TypeScript, Ant Design dashboards.',

      backend:
        'NestJS REST API, Node.js services.',

      database:
        'PostgreSQL with Prisma ORM, Redis caching.',
...

  {
    ...
    tagline:
      'React Native mobile application for tracking network installation and maintenance activities across field engineering teams.',
    ...
    role:
      'Contributed to the development of the mobile application and its operational workflows.',
    ...
    architecture: {
      frontend:
        'React Native, TypeScript, mobile client UI.',

      backend:
        'REST API integrations, report generation service.',

      database:
        'PostgreSQL backend data tier.',

      infrastructure:
        'Mobile bundle builds, API services.'
    },
...
export const OTHER_PROJECTS: Project[] = ALL_PROJECTS.filter(
  (p) =>
    !p.featured &&
    !CLIENT_PROJECTS.some((clientProject) => clientProject.id === p.id)
);